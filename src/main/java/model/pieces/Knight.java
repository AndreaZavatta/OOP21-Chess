...
/**
 * A Knight class that extends {@link model.pieces.AbstractPiece} abstract class.
 */
public class Knight extends AbstractPiece {
    ...
    public List<Position> getAllPossiblePositions(final Chessboard board) {
        return Collections
                .unmodifiableList(this.getPieceMovement().singleMove(PieceDirections.KNIGHT_DIR, board, this));
    }
