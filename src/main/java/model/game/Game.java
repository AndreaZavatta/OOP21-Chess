...
public interface Game {
	 ...
	 * @throws IOException it can throw it when method try to store the game in
	 *                     database
	 */
	...
	/**
	 * This method is taken by Chessboard class in order to use it in the
	 * controller.
	 * 
	...
	/**
	 * Pawn get promoted to the piece with the name taken in input.
	 * 
	 ...
	 * 
	 * @throws IOException It can throw and IOException when it try to store the
	...
	/**
	 * The method finish the game and give victory to the player of the next turn.
	 * 
	...
	/**
	 * Get the FEN string representing the current board state.
	 * 
